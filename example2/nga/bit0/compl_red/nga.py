...
DEBUG = False
REPORT= False
aca_results_file = '../../../aca/bit0/compl_red/combinedresults-sum.yaml'
correlation_or_welcht = 'welcht'
pc_log_dir = '../../../sim/pc_log/compl_red/'
assembly_file = '../../../sim/software/compl_red/present_hiding.dump'
FREQ = 5e7 # 50MHz
pc_log_timescale = 1e-12

TOPLEVEL = 'skivav'
MODULE = 'skivav_present_sbox_hiding_tvla'
