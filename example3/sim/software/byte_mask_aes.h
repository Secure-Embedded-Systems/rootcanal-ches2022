...
void mixColumns(volatile uint8_t state[16]){
...
void shiftRows(volatile uint8_t state[16]){
...
void addRoundKey_masked(volatile uint8_t state[16],uint8_t round){
...
void masked(volatile uint8_t state[16]){
...
void remask(volatile uint8_t s[16], uint8_t m1, uint8_t m2, uint8_t m3, uint8_t m4, uint8_t m5, uint8_t m6, uint8_t m7, uint8_t m8){
...
void subBytes_masked(volatile uint8_t state[16]){
